...
export function drawEstellaGeneratedMission(
  ...
  const transferCostLabels = new Set(['Cluster exit + escape vector', 'SOI escape insertion', 'Midcourse correction reserve', 'Atmospheric entry targeting', 'Arrival/capture reserve', 'Transfer reserve']);
