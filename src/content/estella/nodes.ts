...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  surfacePoi('estella-vi-foundry-complex', 'Estella VI.4', 'Steel Combine', 'estella-vi', 'camps', 'Smelting and heavy refining combine: Kuznia\'s industrial hub.', ['foundry', 'refinery', 'combine'], ['smelted-metals', 'heavy-machinery']),
