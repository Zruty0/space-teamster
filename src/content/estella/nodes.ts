...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  // III. The Belt
  cluster({ id: 'belt-cluster-near', name: 'New Canaan Field', regionId: 'belt', parentId: ROOT_ID, usage: 'co-orbital', summary: 'Old titanium-rush field beside the Caravanserai; now a mined-out backwater of marginal claims and half-warm stations.', tags: ['belt-cluster', 'open', 'home-base-cluster', 'new-canaan'] }),
  ...
  clusterMember({ id: 'prospect-rock-es-c-0101', catalogId: 'ES-C-0101', name: "Mercer's Claim", kind: 'asteroid', regionId: 'belt', parentId: 'belt-cluster-near', x: -26000, y: 22000, summary: 'Old New Canaan claim rock: once a profitable titanium prospect, now a marginal Co-op member operation.', tags: ['prospecting', 'first-contract', 'small-asteroid', 'new-canaan'], economyTags: ['tailings-concentrate', 'basalt-feedstock', 'scrap-alloy', 'local-goods'], layoutId: 'small-asteroid-dock' }),
  aboardPoi('prospect-rock-main-dock', 'ES-C-0101.1', 'Mercer Dock', 'prospect-rock-es-c-0101', 'belt', 'Single dock for Mercer claim crews, tailings lots, and Co-op member resupply.', ['dock', 'prospecting', 'new-canaan'], ['tailings-concentrate', 'supplies']),

  clusterMember({ id: 'survey-rock-es-s-0101', catalogId: 'ES-S-0101', name: "Harlan's Station", kind: 'asteroid', regionId: 'belt', parentId: 'belt-cluster-near', x: 24000, y: 33000, summary: 'Old New Canaan station and informal Miners Mutual headquarters, much of it cold and sealed behind pressure doors.', tags: ['survey', 'beacon', 'small-asteroid', 'new-canaan', 'co-op-hq'], economyTags: ['tailings-concentrate', 'maintenance-supplies', 'local-goods'], layoutId: 'small-asteroid-dock' }),
  aboardPoi('survey-rock-beacon-dock', 'ES-S-0101.1', 'Harlan Dock', 'survey-rock-es-s-0101', 'belt', 'Co-op station dock for member business, beacon service, and bulk supply distribution.', ['dock', 'survey', 'beacon', 'new-canaan', 'co-op-hq'], ['maintenance-supplies', 'supplies']),
