...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  surfacePoi('estella-xd-oathmark-academy', 'Estella Xd.3', 'Oathmark Academy', 'estella-xd', 'wells', 'Prestigious martial academy and neutral proving ground for duelists, household captains, mercenary companies, charter-combat referees, and EDF exchange officers.', ['academy', 'martial', 'ducal', 'neutral-ground', 'edf'], ['passengers', 'security', 'military-training']),
