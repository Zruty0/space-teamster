...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  cluster({ id: 'belt-cluster-wreckage-field', name: 'Arkfall', regionId: 'belt', parentId: ROOT_ID, usage: 'eccentric', summary: 'Military-restricted debris field: shattered remains of the Ark of the Covenant, war grave, navigation hazard, and license-gated salvage zone.', tags: ['belt-cluster', 'salvage', 'hazard', 'arkfall', 'covenant-wars', 'military-restricted'], gameplayTags: ['unexpanded-container', 'salvage-license-required'] }),
