...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  ...stationWithPoi({ stationId: 'estella-v-transit-station', poiId: 'estella-v-transit-customs', catalogId: 'Estella V.1', stationName: 'Hartwell Transit Station', parentId: 'estella-v', regionId: 'camps', summary: 'Transit and customs station for Hartwell.', tags: ['transit', 'customs'] }),
  surfacePoi('estella-v-capital-settlement', 'Estella V.2', 'Hartwell Capital Settlement', 'estella-v', 'camps', 'Passenger/admin capital settlement and old Camps gateway capital.', ['settlement', 'admin', 'frontier-capital'], ['passengers', 'documents']),
  ...
  ...stationWithPoi({ stationId: 'estella-v-orbital-factory', poiId: 'estella-v-high-orbit-factory', catalogId: 'Estella V.7', stationName: 'Hartwell Orbital Factory', parentId: 'estella-v', regionId: 'camps', usage: 'high', summary: 'High-orbit factory.', tags: ['factory'], economyTags: ['manufactured-goods'] }),
  ...
  ...stationWithPoi({ stationId: 'estella-vi-main-dispatch', poiId: 'estella-vi-main-transit-dispatch', catalogId: 'Estella VI.1', stationName: 'Kuznia Main Dispatch Station', parentId: 'estella-vi', regionId: 'camps', summary: 'Main transit and dispatch station.', tags: ['dispatch', 'transit'] }),
  ...stationWithPoi({ stationId: 'estella-vi-heavy-cargo-dispatch', poiId: 'estella-vi-heavy-cargo-station', catalogId: 'Estella VI.2', stationName: 'Kuznia Heavy-Cargo Dispatch', parentId: 'estella-vi', regionId: 'camps', usage: 'high', summary: 'High-orbit heavy-cargo dispatch station.', tags: ['heavy-cargo'], economyTags: ['machinery', 'bulk-cargo'] }),
  ...
  ...stationWithPoi({ stationId: 'estella-via-drydock', poiId: 'estella-via-drydock-station', catalogId: 'Estella VIa.1', stationName: 'Svarog Drydock', parentId: 'estella-via', regionId: 'camps', summary: 'Low-orbit drydock and shipyard at Svarog.', tags: ['drydock', 'shipyard'], economyTags: ['ship-components', 'repairs'] }),
  ...stationWithPoi({ stationId: 'estella-via-component-supply', poiId: 'estella-via-component-supply-station', catalogId: 'Estella VIa.2', stationName: 'Svarog Component Supply', parentId: 'estella-via', regionId: 'camps', usage: 'high', summary: 'High-orbit component supply station at Svarog.', tags: ['components'], economyTags: ['ship-components'] }),
  surfacePoi('estella-via-surface-anchor', 'Estella VIa.3', 'Svarog Surface Anchor', 'estella-via', 'camps', 'Surface anchor and staff habitation for Svarog drydock operations.', ['drydock', 'hab'], ['workers', 'ship-components']),
  surfacePoi('estella-via-rare-alloy-extraction', 'Estella VIa.4', 'Svarog Rare Alloy Extraction', 'estella-via', 'camps', 'Rare alloy extraction site on Svarog.', ['mine'], ['rare-alloys']),

  orbiting({ id: 'estella-vib', catalogId: 'Estella VIb', name: 'Malyna', kind: 'moon', regionId: 'camps', parentId: 'estella-vi', usage: 'moon', summary: 'Bright red airless specialty/pharma moon of Kuznia with hematite-rich regolith and sealed horticulture facilities.', tags: ['airless', 'pharma', 'specialty', 'red-regolith'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...stationWithPoi({ stationId: 'estella-vib-cold-chain-transit', poiId: 'estella-vib-cold-chain-station', catalogId: 'Estella VIb.1', stationName: 'Malyna Cold-Chain Transit', parentId: 'estella-vib', regionId: 'camps', summary: 'Cold-chain transit station for Malyna sealed-life-science cargo.', tags: ['cold-chain'], economyTags: ['pharmaceuticals', 'perishables'] }),
  surfacePoi('estella-vib-vat-protein', 'Estella VIb.2', 'Malyna Vat-Protein Primary', 'estella-vib', 'camps', 'Biotech and vat-protein primary site on Malyna.', ['biotech'], ['vat-protein', 'biotech']),
  surfacePoi('estella-vib-pharma-horticulture', 'Estella VIb.3', 'Malyna Pharmaceutical Horticulture', 'estella-vib', 'camps', 'Pharmaceutical and specialty horticulture site under Malyna red regolith shielding.', ['pharma', 'horticulture'], ['pharmaceuticals', 'specialty-crops']),
  surfacePoi('estella-vib-aquaculture', 'Estella VIb.4', 'Malyna Boutique Aquaculture', 'estella-vib', 'camps', 'Boutique luxury aquaculture facility on Malyna.', ['aquaculture', 'luxury'], ['luxury-food']),
  ...
  ...stationWithPoi({ stationId: 'estella-vii-transit-station', poiId: 'estella-vii-transit-export', catalogId: 'Estella VII.1', stationName: 'Tessera Transit / Export Station', parentId: 'estella-vii', regionId: 'camps', summary: 'Transit and export station for Tessera.', tags: ['transit', 'export'] }),
  surfacePoi('estella-vii-high-vacuum-factory', 'Estella VII.2', 'Tessera High-Vacuum Precision Factory', 'estella-vii', 'camps', 'High-vacuum precision factory.', ['factory', 'high-vacuum'], ['precision-parts']),
