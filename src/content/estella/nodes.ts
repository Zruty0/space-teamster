...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  clusterMember({ id: 'glitterfield-highgrade', catalogId: 'ES-M-0004', name: 'Highgrade Depot', kind: 'asteroid', regionId: 'belt', parentId: 'glitterfield', x: -8000, y: -14000, summary: 'Shared ore-marshalling depot and crew/supply interchange for Glitterfield mining companies.', tags: ['depot', 'mining', 'ore-marshalling'], economyTags: ['ore', 'supplies'], layoutId: 'small-asteroid-dock' }),
  ...
  clusterMember({ id: 'glitterfield-slagfoot', catalogId: 'ES-M-0005', name: 'Slagfoot Depot', kind: 'asteroid', regionId: 'belt', parentId: 'glitterfield', x: 26000, y: -6000, summary: 'Shared ore-marshalling depot and crew/supply interchange for Glitterfield mining companies.', tags: ['depot', 'mining', 'ore-marshalling'], economyTags: ['ore', 'supplies'], layoutId: 'small-asteroid-dock' }),
  ...
  clusterMember({ id: 'glitterfield-deepcut', catalogId: 'ES-M-0006', name: 'Deepcut Depot', kind: 'asteroid', regionId: 'belt', parentId: 'glitterfield', x: -30000, y: -20000, summary: 'Shared ore-marshalling depot and crew/supply interchange for Glitterfield mining companies.', tags: ['depot', 'mining', 'ore-marshalling'], economyTags: ['ore', 'supplies'], layoutId: 'small-asteroid-dock' }),
