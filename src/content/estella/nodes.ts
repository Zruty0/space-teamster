...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  ...stationWithPoi({ stationId: 'estella-x-skim-hub', poiId: 'estella-x-observation-skim-hub', catalogId: 'Estella X.1', stationName: 'Gryphon Skim Hub / Observation', parentId: 'estella-x', regionId: 'wells', summary: 'Orbital skim hub and observation site.', tags: ['skim-hub', 'observation'], economyTags: ['industrial-gas'] }),
  ...
  orbiting({ id: 'estella-xb', catalogId: 'Estella Xb', name: 'Estella Xb', kind: 'moon', regionId: 'wells', parentId: 'estella-x', usage: 'moon', summary: 'Rocky airless moon with rare-element mining, smelting, and one sealed ultra-rich retreat enclave.', tags: ['rocky-moon', 'airless', 'luxury-retreat'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  surfacePoi('estella-xb-luxury-retreat', 'Estella Xb.4', 'Ultra-Luxury Retreat', 'estella-xb', 'wells', 'Sealed resort enclave for ultra-rich guests, dynastic negotiations, rest cures, hidden heirs, and staff traffic.', ['luxury', 'retreat', 'ducal', 'sealed-enclave'], ['luxury-goods', 'passengers', 'medical']),
  ...
  surfacePoi('estella-xc-main-outpost', 'Estella Xc.1', 'Three Houses Seat', 'estella-xc', 'wells', 'Shared court district, chancery halls, embassy stacks, and ceremonial seat of the Three Houses.', ['court', 'three-houses', 'ducal', 'chancery'], ['passengers', 'contracts', 'legal-records']),
  ...stationWithPoi({ stationId: 'estella-xc-transit-refuel-station', poiId: 'estella-xc-transit-refuel', catalogId: 'Estella Xc.2', stationName: 'Thronehold Transit / Refuel Station', parentId: 'estella-xc', regionId: 'wells', summary: 'Transit and refuel station serving court traffic, house retainers, and diplomatic passengers.', tags: ['transit', 'refuel', 'ducal'], economyTags: ['fuel', 'supplies', 'passengers'] }),
  ...
  surfacePoi('estella-xd-proving-grounds', 'Estella Xd.3', 'Military Proving Grounds', 'estella-xd', 'wells', 'Large-scale proving grounds for household maneuvers, charter-combat exercises, vehicle trials, and EDF-observed escalation drills.', ['military', 'proving-ground', 'ducal', 'edf'], ['military-training', 'security', 'vehicles']),
  ...
  clusterMember({ id: 'estella-x-trojan-captive', catalogId: 'ES-C-X-0001', name: 'Gryphon Trojan Captive', kind: 'asteroid', regionId: 'wells', parentId: 'estella-x-captives', x: 0, y: 0, summary: 'Trojan asteroid waypoint for refuel and comm relay.', tags: ['trojan', 'waypoint'], economyTags: ['fuel', 'communications'] }),
  ...
  ...stationWithPoi({ stationId: 'estella-xi-industrial-skim-hub', poiId: 'estella-xi-skim-hub', catalogId: 'Estella XI.1', stationName: 'Hydra Industrial Skim Hub', parentId: 'estella-xi', regionId: 'wells', summary: 'Industrial gas skim hub.', tags: ['skim-hub'], economyTags: ['industrial-gas'] }),
  ...
  orbiting({ id: 'estella-xic', catalogId: 'Estella XIc', name: 'Estella XIc', kind: 'moon', regionId: 'wells', parentId: 'estella-xi', usage: 'moon', summary: 'Ice moon turned licensed vice jurisdiction: casinos, debt courts, body contracts, memory parlors, and bonded pleasure houses over old ice infrastructure.', tags: ['ice-moon', 'airless', 'vice', 'casinos', 'debt-courts'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...stationWithPoi({ stationId: 'estella-xic-research-station', poiId: 'estella-xic-research-station-poi', catalogId: 'Estella XIc.1', stationName: 'Estella XIc Status Court Station', parentId: 'estella-xic', regionId: 'wells', summary: 'Licensed vice station of casinos, debt courts, status arenas, bonded contract houses, and arbitration clerks.', tags: ['vice', 'casino', 'debt-court', 'status'], economyTags: ['passengers', 'luxury-goods', 'legal-records'] }),
  surfacePoi('estella-xic-deep-ice-exobiology', 'Estella XIc.2', 'Memory Parlors / Body Contract Clinics', 'estella-xic', 'wells', 'Sealed clinics for memory edits, body contracts, longevity procedures, and discreet post-vice medical work.', ['medical', 'vice', 'memory', 'body-contracts', 'restricted'], ['medical', 'passengers', 'biological-samples']),
  surfacePoi('estella-xic-ice-mining', 'Estella XIc.3', 'Ice Mining', 'estella-xic', 'wells', 'Old ice mining site supplying the vice habitats and their sealed hotels.', ['mine', 'ice'], ['ice', 'water']),
  ...
  orbiting({ id: 'estella-xie', catalogId: 'Estella XIe', name: 'Oathmark', kind: 'moon', regionId: 'wells', parentId: 'estella-xi', usage: 'moon', summary: 'Small airless neutral moon with the outer-spec drydock, fabrication yards, and Oathmark Academy.', tags: ['small-moon', 'airless', 'drydock', 'oathmark', 'neutral-ground', 'academy'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  surfacePoi('estella-xie-outer-spec-drydock', 'Estella XIe.1', 'Outer-Spec Drydock', 'estella-xie', 'wells', 'Outer-spec drydock and traditional neutral ground of the Wells.', ['drydock', 'neutral-ground'], ['repairs', 'ship-components']),
  surfacePoi('estella-xie-component-fabrication', 'Estella XIe.2', 'Component / Fabrication', 'estella-xie', 'wells', 'Component fabrication site supporting the shipyard and all lawful House fleets.', ['fabrication'], ['ship-components']),
  ...
  orbiting({ id: 'estella-xif', catalogId: 'Estella XIf', name: 'Estella XIf', kind: 'moon', regionId: 'wells', parentId: 'estella-xi', usage: 'moon', summary: 'Small airless observatory moon used as cover for secret AI-governance research.', tags: ['small-moon', 'science', 'airless', 'ai-research', 'restricted'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  surfacePoi('estella-xif-observatory', 'Estella XIf.1', 'Governance Observatory', 'estella-xif', 'wells', 'Public observatory and governance-modeling front office.', ['observatory', 'governance', 'science'], ['science-data']),
  surfacePoi('estella-xif-deep-listening-array', 'Estella XIf.2', 'Deep-Listening / Training Data Array', 'estella-xif', 'wells', 'Deep-listening array that quietly feeds long-horizon administrative and behavioral models.', ['listening-array', 'science', 'ai-research'], ['science-data', 'communications']),
  surfacePoi('estella-xif-sealed-research-outpost', 'Estella XIf.3', 'Sealed AI-Regency Research Outpost', 'estella-xif', 'wells', 'Restricted institute publicly modeling disaster governance and succession logistics while secretly building future machine governors.', ['science', 'restricted', 'ai-research', 'black-project'], ['classified-cargo', 'science-data']),
  ...
  surfacePoi('estella-xiia-deep-ice-mine', 'Estella XIIa.1', 'Covenant Deep Ice Works', 'estella-xiia', 'wells', 'Treaty-enclave deep ice works operated by Covenant remnant households.', ['mine', 'ice', 'covenant-remnant'], ['ice', 'water']),
  surfacePoi('estella-xiia-volatiles-transit', 'Estella XIIa.2', 'Covenant Volatiles Transit', 'estella-xiia', 'wells', 'Manifest-controlled volatiles transit site for the larger Covenant enclave.', ['volatiles', 'transit', 'covenant-remnant'], ['volatiles']),
  surfacePoi('estella-xiia-isolated-settlement', 'Estella XIIa.3', 'Covenant Enclave Settlement', 'estella-xiia', 'wells', 'Closed treaty settlement of Covenant remnant families, clergy, and administrators.', ['settlement', 'isolated', 'covenant-remnant', 'treaty-enclave'], ['supplies', 'passengers', 'pilgrims']),
