...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  ...stationWithPoi({ stationId: 'estella-xic-research-station', poiId: 'estella-xic-research-station-poi', catalogId: 'Estella XIc.1', stationName: 'Estella XIc Status Court Station', parentId: 'estella-xic', regionId: 'wells', summary: 'Licensed station of casinos, debt courts, status arenas, bonded contract houses, and arbitration clerks.', tags: ['casino', 'debt-court', 'status'], economyTags: ['passengers', 'luxury-goods', 'legal-records'] }),
  surfacePoi('estella-xic-deep-ice-exobiology', 'Estella XIc.2', 'Memory Parlors / Body Contract Clinics', 'estella-xic', 'wells', 'Sealed clinics for memory edits, body contracts, longevity procedures, and discreet medical work.', ['medical', 'memory', 'body-contracts', 'restricted'], ['medical', 'passengers', 'biological-samples']),
  surfacePoi('estella-xic-ice-mining', 'Estella XIc.3', 'Ice Mining', 'estella-xic', 'wells', 'Old ice mining site supplying the casino habitats and their sealed hotels.', ['mine', 'ice'], ['ice', 'water']),
