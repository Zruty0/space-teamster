...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  ...stationWithPoi({ stationId: 'estella-v-transit-station', poiId: 'estella-v-transit-customs', catalogId: 'Estella V.1', stationName: 'Roadstead Station', poiName: 'Roadstead Customs', parentId: 'estella-v', regionId: 'camps', usage: 'high', summary: 'Transit and customs station for Hartwell.', tags: ['transit', 'customs'] }),
  ...
  ...stationWithPoi({ stationId: 'estella-v-orbital-factory', poiId: 'estella-v-high-orbit-factory', catalogId: 'Estella V.7', stationName: 'Ascension Scaffold', parentId: 'estella-v', regionId: 'camps', usage: 'low', summary: 'Historic first orbital factory, shipyard, and outward-colonization staging ground; locally, the Old Scaffold.', tags: ['factory', 'shipyard', 'historic'], economyTags: ['manufactured-goods', 'ship-components'] }),
  ...
  surfacePoi('estella-vi-mountain-mining', 'Estella VI.8', 'Kopanka Mine', 'estella-vi', 'camps', 'Specialty ore mountain mining site with hard-pad, high-altitude operations.', ['mine', 'mountain', 'hard-pad'], ['specialty-ore']),
  ...
  ...stationWithPoi({ stationId: 'estella-ix-supply-depot', poiId: 'estella-ix-opposite-sense-supply-depot', catalogId: 'Estella IX.2', stationName: 'Estella IX Supply Depot', parentId: 'estella-ix', regionId: 'belt', summary: 'High-orbit supply depot.', tags: ['supply-depot', 'high-orbit'], economyTags: ['supplies'] }),
  ...
  ...stationWithPoi({ stationId: 'estella-xii-observation-post-station', poiId: 'estella-xii-observation-post', catalogId: 'Estella XII.1', stationName: 'Manticore Observatory', parentId: 'estella-xii', regionId: 'wells', summary: 'Low orbital observatory focused on Manticore itself: weather, bands, skim hazards, storm chemistry, and inner-magnetosphere monitoring.', tags: ['observation', 'observatory', 'manticore'], economyTags: ['science-data'] }),
  ...
  surfacePoi('estella-xiib-outpost', 'Estella XIIb.1', 'Vigil Keep', 'estella-xiib', 'wells', 'Surface watch, Warden\'s seat, and armed Covenant observance post with strict entry and manifest rules.', ['outpost', 'covenant-remnant', 'watch', 'keep'], ['supplies', 'pilgrims', 'security']),
  ...stationWithPoi({ stationId: 'estella-xiib-transit-station', poiId: 'estella-xiib-transit-station-poi', catalogId: 'Estella XIIb.2', stationName: 'Vigil Gate', parentId: 'estella-xiib', regionId: 'wells', summary: 'Controlled orbital pilgrim and treaty transit gate serving the smaller Covenant enclave.', tags: ['transit', 'covenant-remnant', 'pilgrims', 'gate'], economyTags: ['passengers', 'supplies', 'pilgrims'] }),
  orbiting({ id: 'estella-xiic', catalogId: 'Estella XIIc', name: 'Teide', kind: 'moon', regionId: 'wells', parentId: 'estella-xii', usage: 'moon', summary: 'Captured comet/KBO-like airless moon and economically viable isotope-prospecting county.', tags: ['comet', 'kbo', 'airless', 'isotopes'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  surfacePoi('estella-xiic-isotope-mining', 'Estella XIIc.1', 'Bluefire Mine', 'estella-xiic', 'wells', 'High-value isotope extraction works on Teide.', ['mine', 'isotopes'], ['isotopes']),
  surfacePoi('estella-xiic-comet-research', 'Estella XIIc.2', 'Teide Survey Collegium', 'estella-xiic', 'wells', 'Applied comet/KBO research, prospecting science, and mining survey house.', ['science', 'comet', 'collegium', 'survey'], ['science-data']),
  surfacePoi('estella-xiic-castle-teide', 'Estella XIIc.3', 'Castle Teide', 'estella-xiic', 'wells', 'Count\'s seat, charter office, isotope brokers, and crew administration for Teide.', ['castle', 'ducal', 'admin'], ['passengers', 'documents', 'isotopes']),
  orbiting({ id: 'estella-xiid', catalogId: 'Estella XIId', name: 'Ceuta', kind: 'moon', regionId: 'wells', parentId: 'estella-xii', usage: 'moon', summary: 'Small airless House Nunes seat: research, espionage, leverage, and hidden augmentation.', tags: ['small-moon', 'airless', 'restricted', 'nunes', 'espionage'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  surfacePoi('estella-xiid-black-project-exile', 'Estella XIId.1', 'Castle Nunes', 'estella-xiid', 'wells', 'House Nunes seat of power: ducal court, private archives, espionage ministry, blackmail files, hostage-guests, and Manticore backchannels.', ['castle', 'nunes', 'espionage', 'restricted'], ['classified-cargo', 'prisoners', 'documents']),
  surfacePoi('estella-xiid-blackglass-observatory', 'Estella XIId.2', 'Blackglass Observatory', 'estella-xiid', 'wells', 'Nunes research hub, academy, and deep observatory for outer-system signals, forbidden analysis, and secrets of the universe.', ['observatory', 'academy', 'nunes', 'restricted'], ['science-data', 'classified-cargo']),
  surfacePoi('estella-xiid-mirror-clinic', 'Estella XIId.3', 'Mirror Clinic', 'estella-xiid', 'wells', 'Hidden augmentation and identity clinic for neural edits, counter-interrogation implants, cosmetic reconstruction, and deniable self-reinvention.', ['medical', 'augmentation', 'nunes', 'restricted'], ['medical', 'classified-cargo', 'passengers']),
  ...
  clusterMember({ id: 'estella-xii-captive-comm-relay', catalogId: 'ES-I-XII-0002', name: 'The Far Bell Tower', kind: 'comet-fragment', regionId: 'wells', parentId: 'estella-xii-captives', x: 10000, y: -12000, summary: 'Icy outer telescope, comm relay, and intercept facility at the edge of Manticore traffic.', tags: ['communications', 'bell-tower', 'telescope', 'intercept'], economyTags: ['communications', 'science-data'] }),
  aboardPoi('estella-xii-comm-relay-poi', 'ES-I-XII-0002.1', 'The Far Bell Tower', 'estella-xii-captive-comm-relay', 'wells', 'Dock-only deep-space telescope, comm relay, intercept post, and outer warning bell.', ['dock-only', 'communications', 'bell-tower', 'telescope', 'intercept'], ['communications', 'science-data']),
