...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  orbiting({ id: 'estella-va', catalogId: 'Estella Va', name: 'Hartwell Va', kind: 'moon', regionId: 'camps', parentId: 'estella-v', usage: 'moon', summary: 'Small airless moon of Hartwell used for ore handling and strip mining.', tags: ['airless', 'moon', 'mining'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  ...stationWithPoi({ stationId: 'estella-va-ore-depot', poiId: 'estella-va-ore-handling-depot', catalogId: 'Estella Va.3', stationName: 'Hartwell Va Ore-Handling Depot', parentId: 'estella-va', regionId: 'camps', summary: 'Low-orbit ore-handling depot.', tags: ['ore-depot'], economyTags: ['heavy-ore'] }),
  ...
  orbiting({ id: 'estella-via', catalogId: 'Estella VIa', name: 'Kuznia VIa', kind: 'moon', regionId: 'camps', parentId: 'estella-vi', usage: 'moon', summary: 'Small airless shipyard moon of Kuznia.', tags: ['airless', 'shipyard'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...stationWithPoi({ stationId: 'estella-via-drydock', poiId: 'estella-via-drydock-station', catalogId: 'Estella VIa.1', stationName: 'Kuznia VIa Drydock', parentId: 'estella-via', regionId: 'camps', summary: 'Low-orbit drydock and shipyard.', tags: ['drydock', 'shipyard'], economyTags: ['ship-components', 'repairs'] }),
  ...stationWithPoi({ stationId: 'estella-via-component-supply', poiId: 'estella-via-component-supply-station', catalogId: 'Estella VIa.2', stationName: 'Kuznia VIa Component Supply', parentId: 'estella-via', regionId: 'camps', usage: 'high', summary: 'High-orbit component supply station.', tags: ['components'], economyTags: ['ship-components'] }),
  ...
  orbiting({ id: 'estella-vib', catalogId: 'Estella VIb', name: 'Kuznia VIb', kind: 'moon', regionId: 'camps', parentId: 'estella-vi', usage: 'moon', summary: 'Small airless specialty/pharma moon of Kuznia.', tags: ['airless', 'pharma', 'specialty'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...stationWithPoi({ stationId: 'estella-vib-cold-chain-transit', poiId: 'estella-vib-cold-chain-station', catalogId: 'Estella VIb.1', stationName: 'Kuznia VIb Cold-Chain Transit', parentId: 'estella-vib', regionId: 'camps', summary: 'Cold-chain transit station.', tags: ['cold-chain'], economyTags: ['pharmaceuticals', 'perishables'] }),
