...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  surfacePoi('estella-xif-observatory', 'Estella XIf.1', 'Regent Cradle', 'estella-xif', 'wells', 'Main AI-regency development campus where prototype machine governors are grown, trained, and ceremonially presented as administrative tools.', ['ai-research', 'governance', 'restricted'], ['science-data', 'classified-cargo']),
  surfacePoi('estella-xif-deep-listening-array', 'Estella XIf.2', 'Corpus Tower', 'estella-xif', 'wells', 'Training-data tower that ingests court records, traffic patterns, broadcasts, petitions, and behavioral archives for regency-model development.', ['listening-array', 'ai-research', 'training-data'], ['science-data', 'communications']),
  surfacePoi('estella-xif-sealed-research-outpost', 'Estella XIf.3', 'Mindwright House', 'estella-xif', 'wells', 'Sealed laboratory for boxing, alignment, succession simulations, and dangerous machine-regent trials.', ['restricted', 'ai-research', 'black-project'], ['classified-cargo', 'science-data']),
