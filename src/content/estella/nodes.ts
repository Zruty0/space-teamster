...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  surfacePoi('estella-xif-observatory', 'Estella XIf.1', 'Coimbra Server Farm', 'estella-xif', 'wells', 'Hardened compute and storage farm running public cloud contracts, driver validation, simulation workloads, and hidden model-training capacity.', ['ai-research', 'compute', 'server-farm', 'restricted'], ['science-data', 'classified-cargo']),
  surfacePoi('estella-xif-deep-listening-array', 'Estella XIf.2', 'Coimbra Systems Campus', 'estella-xif', 'wells', 'Sprawling commercial R&D campus selling computational electronics, flight accelerators, embedded controllers, and certified driver stacks across the Wells.', ['electronics', 'r-and-d', 'ai-research', 'compute'], ['science-data', 'electronics']),
  surfacePoi('estella-xif-sealed-research-outpost', 'Estella XIf.3', 'Pinnacle Lab', 'estella-xif', 'wells', 'Secret AI development laboratory for frontier model training, containment, alignment, and prototype machine-governance trials.', ['restricted', 'ai-research', 'black-project'], ['classified-cargo', 'science-data']),
