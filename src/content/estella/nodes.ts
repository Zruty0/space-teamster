...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  surfacePoi('estella-xc-main-outpost', 'Estella Xc.1', 'The Serratine High Court', 'estella-xc', 'wells', 'Grand shared capital district of Thronehold: chancery halls, embassy stacks, ceremonial courts, and the formal seat of the Three Houses.', ['court', 'three-houses', 'ducal', 'chancery', 'capital'], ['passengers', 'contracts', 'legal-records']),
