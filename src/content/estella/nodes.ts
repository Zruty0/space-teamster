...
export const ESTELLA_NODE_BLUEPRINTS: WorldNode[] = [
  ...
  surfacePoi('estella-xic-last-breath-lists', 'Estella XIc.4', 'Last Breath Lists', 'estella-xic', 'wells', 'Vacuum-ice race tracks, survival jousts, and wagered endurance contests staged for Macao spectators.', ['sports', 'casino', 'survival-racing', 'lists', 'status'], ['passengers', 'luxury-goods', 'medical']),
