...
const ESTELLA_HEARTH_ATMO_SURFACE_PROFILE: EstellaSurfaceFlightProfile = {
  ...
  departureProfile: {
    ...
    startVY: 5,
    exitAltitude: 30_000,
    thresholdApoapsisAltitude: 110_000,
...
const ESTELLA_II_NIMBUS_CRUCIBLE_PROFILE: EstellaSurfaceFlightProfile = {
  ...
  departureProfile: {
    ...
    exitAltitude: 75_000,
    thresholdApoapsisAltitude: 137_500,
...
const ESTELLA_CAMPS_THIN_ATMO_SURFACE_PROFILE: EstellaSurfaceFlightProfile = {
  ...
  departureProfile: {
    ...
    startVY: 5,
    exitAltitude: 28_000,
    thresholdApoapsisAltitude: 70_000,
...
const ESTELLA_CAMPS_THICK_ATMO_SURFACE_PROFILE: EstellaSurfaceFlightProfile = {
  ...
  departureProfile: {
    ...
    startVY: 5,
    exitAltitude: 55_000,
    thresholdApoapsisAltitude: 112_500,
...
const ESTELLA_WELLS_THIN_ATMO_SURFACE_PROFILE: EstellaSurfaceFlightProfile = {
  ...
  departureProfile: {
    ...
    exitAltitude: 22_000,
    thresholdApoapsisAltitude: 55_000,
...
const ESTELLA_WELLS_METHANE_SURFACE_PROFILE: EstellaSurfaceFlightProfile = {
  ...
  departureProfile: {
    ...
    exitAltitude: 45_000,
    thresholdApoapsisAltitude: 122_500,
    targetOrbitAltitude: 160_000,
  },
};
...
export const ESTELLA_SURFACE_FLIGHT_PROFILES: Partial<Record<string, EstellaSurfaceFlightProfile>> = {
  ...
  'estella-xb-luxury-retreat': ESTELLA_WELLS_AIRLESS_SURFACE_PROFILE,
  'estella-xc-main-outpost': ESTELLA_WELLS_AIRLESS_SURFACE_PROFILE,
  'estella-xc-castle-alvares': ESTELLA_WELLS_AIRLESS_SURFACE_PROFILE,
  ...
  'estella-xie-oathmark-academy': ESTELLA_WELLS_AIRLESS_SURFACE_PROFILE,
