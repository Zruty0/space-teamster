...
const MINERS_MUTUAL_TEMPLATES: MinersMutualContractTemplate[] = [
  ...
  { templateId: 'serai-oxygen-bottles', sourceIds: ['caravanserai-refuel-depot'], destinationIds: NEW_CANAAN_DOCKS, cargoLabel: 'emergency oxygen bottles', massClass: 'light', likelihood: 0.45, generosity: MINERS_MUTUAL_EMERGENCY_GENEROSITY, compensationRatio: MINERS_MUTUAL_EMERGENCY_COMPENSATION_RATIO, requiredCertification: 'volatile-cargo' },
