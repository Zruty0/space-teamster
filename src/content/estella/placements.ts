...
export const ESTELLA_PLACEMENTS: Partial<Record<string, Placement>> = {
  ...
  'estella-xb-luxury-retreat': { kind: 'surface', parentId: 'estella-xb', angle: -2.25, side: 'unspecified' },
  'estella-xc-main-outpost': { kind: 'surface', parentId: 'estella-xc', angle: 0.9, side: 'equatorial' },
  'estella-xc-castle-alvares': { kind: 'surface', parentId: 'estella-xc', angle: 2.15, side: 'equatorial' },
  ...
  'estella-xie-oathmark-academy': { kind: 'surface', parentId: 'estella-xie', angle: -0.95, side: 'equatorial' },
