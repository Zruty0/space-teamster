import { type AccessPoint, type AtmosphereModel, type InstitutionDef, type RegionId, type WorldNode, type WorldNodeKind, validateWorldTree } from './types';
...
function orbiting(args: {
  ...
  return {
    ...
    placement: { kind: 'orbit', parentId: args.parentId, orbitClass: args.orbitClass },
...
function cluster(args: {
  ...
  regionId: RegionId;
  parentId: string;
  orbitClass?: 'co-orbital' | 'eccentric' | 'outer' | 'swarm';
  summary: string;
  tags?: string[];
  gameplayTags?: string[];
}): WorldNode {
...
function stationWithPoi(args: {
  ...
  parentId: string;
  regionId: RegionId;
  orbitClass?: 'low' | 'high' | 'very-inner' | 'stellar' | 'planetary' | 'moon';
  summary: string;
  tags?: string[];
  economyTags?: string[];
  layoutId?: string;
  ...
  return [
    orbiting({
      ...
      regionId: args.regionId,
      parentId: args.parentId,
      orbitClass: args.orbitClass ?? 'low',
      summary: args.summary,
      tags: args.tags,
      economyTags: args.economyTags,
...
export const ESTELLA_NODES: WorldNode[] = [
  {
    id: ROOT_ID,
    catalogId: 'Estella',
    name: 'Estella',
  ...
  orbiting({ id: 'estella-ii', catalogId: 'Estella II', name: 'Estella II', kind: 'planet', regionId: 'hearth', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Venus-like world with toxic lower atmosphere and a habitable upper cloud layer.', tags: ['venus-like', 'toxic-atmosphere', 'cloud-city'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true }, atmosphere: atmosphere('venuslike-toxic', 'Playable work centers on the habitable upper-atmosphere cloud layer; surface is endgame/deep-pressure.') }),
  orbiting({ id: 'estella-ii-cloud-city-platform', catalogId: undefined, name: 'The Cloud City', kind: 'atmospheric-station', regionId: 'hearth', parentId: 'estella-ii', orbitClass: 'low', summary: 'Iconic atmospheric city in Estella II\'s habitable upper layer.', tags: ['cloud-city', 'luxury', 'atmospheric-platform'], capabilities: { dockable: true, atmosphericPlatform: true }, layoutId: 'cloud-city-exterior', accessPoints: [ap('cloud-city-dock-a', 'Cloud Dock A', 'docking-berth', ['estella-ii-cloud-city'], -80, 0, 0), ap('cloud-city-dock-b', 'Cloud Dock B', 'docking-berth', ['estella-ii-cloud-city'], 80, 0, Math.PI)] }),
  aboardPoi('estella-ii-cloud-city', 'Estella II.1', 'The Cloud City', 'estella-ii-cloud-city-platform', 'hearth', 'Habitable upper-atmosphere city at about 50 km; premium passenger and luxury cargo destination.', ['luxury', 'passenger', 'iconic'], ['luxury-goods', 'passengers', 'premium-cargo']),
  orbiting({ id: 'estella-ii-science-platform', name: 'Estella II Atmospheric Science Platform', kind: 'atmospheric-station', regionId: 'hearth', parentId: 'estella-ii', orbitClass: 'low', summary: 'Mid-altitude atmospheric science platform.', tags: ['science', 'atmospheric-platform'], capabilities: { dockable: true, atmosphericPlatform: true }, accessPoints: [ap('estella-ii-science-dock', 'Science Dock', 'docking-berth', ['estella-ii-atmo-science'])] }),
  aboardPoi('estella-ii-atmo-science', 'Estella II.2', 'Atmospheric Science Platform', 'estella-ii-science-platform', 'hearth', 'Mid-altitude atmospheric science platform.', ['science'], ['science-data', 'instruments']),
  surfacePoi('estella-ii-deep-pressure-ops', 'Estella II.3', 'Deep-Pressure Surface Operations', 'estella-ii', 'hearth', 'Specialty deep-pressure surface operations; effectively one-way for most ships.', ['deep-pressure', 'endgame', 'hazard'], ['pressure-equipment', 'rare-samples']),

  orbiting({ id: 'estella-iii', catalogId: 'Estella III', name: 'Estella III', kind: 'planet', regionId: 'hearth', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Earth-like capital world: old money, government, dense traffic, and breathable atmosphere.', tags: ['earth-like', 'capital', 'civilized'], economyTags: ['consumer-goods', 'electronics', 'pharmaceuticals', 'luxury-goods'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true, landable: true }, atmosphere: atmosphere('breathable', 'Earth-like breathable atmosphere.') }),
  ...stationWithPoi({ stationId: 'estella-iii-main-customs-station', poiId: 'estella-iii-main-customs', catalogId: 'Estella III.1', stationName: 'Estella III Main Customs Station', poiName: 'Main Customs and Arrival Hub', parentId: 'estella-iii', regionId: 'hearth', summary: 'Main customs and arrival station for Estella III.', tags: ['customs', 'arrival-hub'], economyTags: ['inspection', 'passengers'] }),
  ...stationWithPoi({ stationId: 'estella-iii-luxury-habitat', poiId: 'estella-iii-luxury-orbital-habitat', catalogId: 'Estella III.2', stationName: 'Estella III Luxury Orbital Habitat', parentId: 'estella-iii', regionId: 'hearth', orbitClass: 'high', summary: 'High-orbit luxury habitat.', tags: ['luxury', 'habitat'], economyTags: ['luxury-goods', 'passengers'] }),
  ...
  orbiting({ id: 'estella-iv', catalogId: 'Estella IV', name: 'Estella IV', kind: 'planet', regionId: 'hearth', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Earth-like sister/rival world with writer-defined biome and culture.', tags: ['earth-like', 'rival-world'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true, landable: true }, atmosphere: atmosphere('breathable') }),
  ...stationWithPoi({ stationId: 'estella-iv-main-station', poiId: 'estella-iv-main-orbital-station', catalogId: 'Estella IV.1', stationName: 'Estella IV Main Orbital Station', parentId: 'estella-iv', regionId: 'hearth', summary: 'Main orbital station for Estella IV.', tags: ['transit'], economyTags: ['passengers', 'consumer-goods'] }),
  surfacePoi('estella-iv-primary-city', 'Estella IV.2', 'Primary City / Port', 'estella-iv', 'hearth', 'Primary city and port.', ['city', 'port'], ['passengers', 'consumer-goods']),
  surfacePoi('estella-iv-climate-poi-1', 'Estella IV.3', 'Climate-Defining Surface POI 1', 'estella-iv', 'hearth', 'Writer-defined climate/culture POI.', ['writer-territory'], ['regional-goods']),
  surfacePoi('estella-iv-climate-poi-2', 'Estella IV.4', 'Climate-Defining Surface POI 2', 'estella-iv', 'hearth', 'Writer-defined climate/culture POI.', ['writer-territory'], ['regional-goods']),
  surfacePoi('estella-iv-climate-poi-3', 'Estella IV.5', 'Climate-Defining Surface POI 3', 'estella-iv', 'hearth', 'Writer-defined climate/culture POI.', ['writer-territory'], ['regional-goods']),

  ...stationWithPoi({ stationId: 'skim-hub-alpha', poiId: 'skim-hub-alpha-precursor-dock', catalogId: 'Skim Hub Alpha', stationName: 'Skim Hub Alpha', parentId: ROOT_ID, regionId: 'hearth', orbitClass: 'very-inner', summary: 'Primary stellar antimatter precursor receiving station and skim crew base.', tags: ['skim-hub', 'guild', 'hazard'], economyTags: ['antimatter-precursor'] }),
  ...stationWithPoi({ stationId: 'skim-hub-beta', poiId: 'skim-hub-beta-precursor-dock', catalogId: 'Skim Hub Beta', stationName: 'Skim Hub Beta', parentId: ROOT_ID, regionId: 'hearth', orbitClass: 'very-inner', summary: 'Secondary/backup stellar antimatter precursor station.', tags: ['skim-hub', 'guild', 'backup'], economyTags: ['antimatter-precursor'] }),
  ...stationWithPoi({ stationId: 'coronal-observation-post', poiId: 'coronal-observation-post-ops', catalogId: 'Coronal Observation Post', stationName: 'Coronal Observation Post', parentId: ROOT_ID, regionId: 'hearth', orbitClass: 'very-inner', summary: 'Innermost coronal observation and endgame operations post.', tags: ['skim-hub', 'science', 'endgame'], economyTags: ['science-data', 'antimatter-precursor'] }),

  // II. The Camps
  orbiting({ id: 'estella-v', catalogId: 'Estella V', name: 'Estella V', kind: 'planet', regionId: 'camps', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Mars-like industrial planet with thin CO2 atmosphere and dust storms.', tags: ['mars-like', 'thin-atmosphere', 'dust-storms'], economyTags: ['ore', 'refined-goods'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true, landable: true }, atmosphere: atmosphere('thin-co2', 'Dust storms and thin CO2 atmosphere.') }),
  ...
  ...stationWithPoi({ stationId: 'estella-v-orbital-factory', poiId: 'estella-v-high-orbit-factory', catalogId: 'Estella V.7', stationName: 'Estella V Orbital Factory', parentId: 'estella-v', regionId: 'camps', orbitClass: 'high', summary: 'High-orbit factory.', tags: ['factory'], economyTags: ['manufactured-goods'] }),

  orbiting({ id: 'estella-va', catalogId: 'Estella Va', name: 'Estella Va', kind: 'moon', regionId: 'camps', parentId: 'estella-v', orbitClass: 'moon', summary: 'Small airless moon of Estella V used for ore handling and strip mining.', tags: ['airless', 'moon', 'mining'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  ...stationWithPoi({ stationId: 'estella-vi-heavy-cargo-dispatch', poiId: 'estella-vi-heavy-cargo-station', catalogId: 'Estella VI.2', stationName: 'Estella VI Heavy-Cargo Dispatch', parentId: 'estella-vi', regionId: 'camps', orbitClass: 'high', summary: 'High-orbit heavy-cargo dispatch station.', tags: ['heavy-cargo'], economyTags: ['machinery', 'bulk-cargo'] }),
  ...
  orbiting({ id: 'estella-via', catalogId: 'Estella VIa', name: 'Estella VIa', kind: 'moon', regionId: 'camps', parentId: 'estella-vi', orbitClass: 'moon', summary: 'Small airless shipyard moon.', tags: ['airless', 'shipyard'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  ...stationWithPoi({ stationId: 'estella-via-component-supply', poiId: 'estella-via-component-supply-station', catalogId: 'Estella VIa.2', stationName: 'Estella VIa Component Supply', parentId: 'estella-via', regionId: 'camps', orbitClass: 'high', summary: 'High-orbit component supply station.', tags: ['components'], economyTags: ['ship-components'] }),
  ...
  orbiting({ id: 'estella-vii', catalogId: 'Estella VII', name: 'Estella VII', kind: 'planet', regionId: 'camps', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Small airless rocky precision-ops planet.', tags: ['airless', 'precision-ops'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  // III. The Belt
  cluster({ id: 'belt-cluster-near', name: 'Cluster 1 — The Near', regionId: 'belt', parentId: ROOT_ID, orbitClass: 'co-orbital', summary: 'Co-orbital with the Caravanserai; first-contract rocks and beginner work.', tags: ['belt-cluster', 'open', 'home-base-cluster'] }),
  cluster({ id: 'belt-cluster-working', name: 'Cluster 2 — The Working', regionId: 'belt', parentId: ROOT_ID, orbitClass: 'co-orbital', summary: 'Active industrial mid-Belt cluster.', tags: ['belt-cluster', 'open'], gameplayTags: ['unexpanded-container'] }),
  cluster({ id: 'belt-cluster-outer-drift', name: 'Cluster 3 — The Outer Drift', regionId: 'belt', parentId: ROOT_ID, orbitClass: 'co-orbital', summary: 'Sparser, more varied Belt cluster with longer transfers.', tags: ['belt-cluster', 'open'] }),
  cluster({ id: 'belt-cluster-wreckage-field', name: 'Cluster 4 — The Wreckage Field', regionId: 'belt', parentId: ROOT_ID, orbitClass: 'eccentric', summary: 'Dense eccentric-orbit field with navigation hazard and salvage flavor; license-gated.', tags: ['belt-cluster', 'salvage', 'hazard'], gameplayTags: ['unexpanded-container', 'salvage-license-required'] }),
  cluster({ id: 'belt-cluster-quiet-side', name: 'Cluster 5 — The Quiet Side', regionId: 'belt', parentId: ROOT_ID, orbitClass: 'outer', summary: 'Outer co-planar cluster with smuggler dead-drops and reputation-gated rare work.', tags: ['belt-cluster', 'smuggling', 'reputation-gated'] }),
  ...
  orbiting({ id: 'estella-viii', catalogId: 'Estella VIII', name: 'Estella VIII', kind: 'dwarf-planet', regionId: 'belt', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Friendly settled dwarf planet; first proper orbital-body training in the Belt.', tags: ['dwarf-planet', 'training', 'airless'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  ...stationWithPoi({ stationId: 'estella-viii-high-station', poiId: 'estella-viii-harder-approach-station', catalogId: 'Estella VIII.2', stationName: 'Estella VIII Higher Orbit Station', parentId: 'estella-viii', regionId: 'belt', orbitClass: 'high', summary: 'Higher-orbit station with harder approach and more cargo.', tags: ['rendezvous', 'higher-orbit'] }),
  ...
  orbiting({ id: 'estella-ix', catalogId: 'Estella IX', name: 'Estella IX', kind: 'dwarf-planet', regionId: 'belt', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Icy scientific dwarf planet with small SOI and less development.', tags: ['dwarf-planet', 'icy', 'science'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  // IV. The Wells
  orbiting({ id: 'estella-x', catalogId: 'Estella X', name: 'Estella X', kind: 'gas-giant', regionId: 'wells', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Warm inner giant, Saturn-flavored and friendliest of the Wells.', tags: ['gas-giant', 'warm-inner-giant'], capabilities: { hasGravityWell: true, hasSOI: true, hasAtmosphere: true, skimOnly: true }, atmosphere: atmosphere('gas-giant', 'Upper-atmosphere skim only; not landable.', true) }),
  ...
  cluster({ id: 'estella-x-captives', name: 'Estella X Captives', regionId: 'wells', parentId: 'estella-x', orbitClass: 'co-orbital', summary: 'Trojan/captured docking-only asteroid(s) in Estella X\'s SOI.', tags: ['captives', 'dock-only'] }),
  ...
  orbiting({ id: 'estella-xi', catalogId: 'Estella XI', name: 'Estella XI', kind: 'gas-giant', regionId: 'wells', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Big Jupiter-flavored giant: largest, busiest, and most exotic of the Wells.', tags: ['gas-giant', 'big-giant', 'busy'], capabilities: { hasGravityWell: true, hasSOI: true, hasAtmosphere: true, skimOnly: true }, atmosphere: atmosphere('gas-giant', 'Upper-atmosphere skim possible.', true) }),
  ...
  ...stationWithPoi({ stationId: 'estella-xi-observation-transit-nexus', poiId: 'estella-xi-observation-nexus', catalogId: 'Estella XI.2', stationName: 'Estella XI Observation / Transit Nexus', parentId: 'estella-xi', regionId: 'wells', summary: 'Observation and transit nexus.', tags: ['observation', 'transit'], economyTags: ['science-data', 'passengers'] }),
  orbiting({ id: 'estella-xia', catalogId: 'Estella XIa', name: 'Estella XIa', kind: 'moon', regionId: 'wells', parentId: 'estella-xi', orbitClass: 'moon', summary: 'Sulfur volcanic hostile moon with thin SO2 atmosphere.', tags: ['sulfur', 'volcanic', 'hostile'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true, landable: true }, atmosphere: atmosphere('thin-so2', 'Thin hostile SO2 atmosphere.') }),
  ...
  orbiting({ id: 'estella-xib', catalogId: 'Estella XIb', name: 'Estella XIb', kind: 'moon', regionId: 'wells', parentId: 'estella-xi', orbitClass: 'moon', summary: 'Methane/nitrogen moon with thick cold methane atmosphere.', tags: ['methane', 'thick-atmosphere', 'cryo'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true, landable: true }, atmosphere: atmosphere('methane-nitrogen', 'Thick cold methane/nitrogen atmosphere.') }),
  ...
  orbiting({ id: 'estella-xic', catalogId: 'Estella XIc', name: 'Estella XIc', kind: 'moon', regionId: 'wells', parentId: 'estella-xi', orbitClass: 'moon', summary: 'Ice moon with subsurface ocean and airless surface.', tags: ['ice-moon', 'airless'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  cluster({ id: 'estella-xi-captives', name: 'Estella XI Captives', regionId: 'wells', parentId: 'estella-xi', orbitClass: 'co-orbital', summary: 'Four docking-only captured asteroids in Estella XI\'s SOI.', tags: ['captives', 'dock-only'] }),
  ...
  orbiting({ id: 'estella-xiib', catalogId: 'Estella XIIb', name: 'Estella XIIb', kind: 'moon', regionId: 'wells', parentId: 'estella-xii', orbitClass: 'moon', summary: 'Small airless rocky moon.', tags: ['small-moon', 'airless'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  orbiting({ id: 'estella-xiic', catalogId: 'Estella XIIc', name: 'Estella XIIc', kind: 'moon', regionId: 'wells', parentId: 'estella-xii', orbitClass: 'moon', summary: 'Captured comet/KBO, airless.', tags: ['comet', 'kbo', 'airless'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  cluster({ id: 'estella-xii-captives', name: 'Estella XII Captives', regionId: 'wells', parentId: 'estella-xii', orbitClass: 'co-orbital', summary: 'Two icy captured asteroid/comet sites in Estella XII\'s SOI.', tags: ['captives', 'icy', 'dock-only'] }),
  ...
  // V. The Reach
  orbiting({ id: 'estella-xiii', catalogId: 'Estella XIII', name: 'Estella XIII', kind: 'dwarf-planet', regionId: 'reach', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Primary ice dwarf and de facto capital of the Reach.', tags: ['ice-dwarf', 'reach-capital'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  orbiting({ id: 'estella-xiv', catalogId: 'Estella XIV', name: 'Estella XIV', kind: 'dwarf-planet', regionId: 'reach', parentId: ROOT_ID, orbitClass: 'stellar', summary: 'Smaller ice dwarf/rogue planetoid with eccentric inhabitants.', tags: ['ice-dwarf', 'eccentric'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  cluster({ id: 'reach-comet-swarm', name: 'Captured Comet Swarm', regionId: 'reach', parentId: ROOT_ID, orbitClass: 'swarm', summary: 'Fragmented captured periodic comet: tight swarm of six icy docking-only bodies.', tags: ['comet-swarm', 'cluster-mode', 'dock-only'] }),
  ...
  clusterMember({ id: 'reach-comet-fragment-2', catalogId: 'ES-I-RC-0002', name: 'Comet Fragment 2', kind: 'comet-fragment', regionId: 'reach', parentId: 'reach-comet-swarm', x: 9000, y: 6000, summary: 'Icy fragment with prospector cache.', tags: ['prospector-cache'], economyTags: ['supplies', 'salvage'] }),
  ...
  clusterMember({ id: 'reach-comet-fragment-3', catalogId: 'ES-I-RC-0003', name: 'Comet Fragment 3', kind: 'comet-fragment', regionId: 'reach', parentId: 'reach-comet-swarm', x: -6000, y: 11000, summary: 'Icy fragment with dead-drop.', tags: ['dead-drop'], economyTags: ['deniable-cargo'] }),
  ...
  clusterMember({ id: 'reach-comet-fragment-4', catalogId: 'ES-I-RC-0004', name: 'Comet Fragment 4', kind: 'comet-fragment', regionId: 'reach', parentId: 'reach-comet-swarm', x: 15000, y: -3000, summary: 'Icy fragment with isolated science cell.', tags: ['science'], economyTags: ['science-data'] }),
  ...
  clusterMember({ id: 'reach-comet-fragment-5', catalogId: 'ES-I-RC-0005', name: 'Comet Fragment 5', kind: 'comet-fragment', regionId: 'reach', parentId: 'reach-comet-swarm', x: -13000, y: -9000, summary: 'Icy fragment with ice mining.', tags: ['ice-mining'], economyTags: ['ice'] }),
  ...
  clusterMember({ id: 'reach-comet-fragment-6', catalogId: 'ES-I-RC-0006', name: 'Comet Fragment 6', kind: 'comet-fragment', regionId: 'reach', parentId: 'reach-comet-swarm', x: 5000, y: -15000, summary: 'Icy fragment with isolated science cell.', tags: ['science'], economyTags: ['science-data'] }),
  ...
  orbiting({ id: 'reach-rogue-kbo-fragment', catalogId: 'ES-I-RK-0001', name: 'Captured Rogue Planetoid / KBO Fragment', kind: 'dwarf-planet', regionId: 'reach', parentId: ROOT_ID, orbitClass: 'outer', summary: 'Lonely eccentric captured rogue planetoid/KBO fragment.', tags: ['rogue', 'kbo', 'lonely'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, landable: true }, atmosphere: atmosphere('none', undefined, false) }),
  ...
  orbiting({ id: 'deepest-dock-body', catalogId: 'ES-I-DD-0001', name: 'The Deepest Dock', kind: 'comet-fragment', regionId: 'reach', parentId: ROOT_ID, orbitClass: 'outer', summary: 'Small dead asteroid or comet fragment on the far side of the Reach: the literal end of the line.', tags: ['deepest-dock', 'end-of-line', 'writer-territory'], capabilities: { dockable: true, dockOnly: true }, accessPoints: [ap('deepest-dock-berth', 'The Deepest Dock', 'docking-berth', ['deepest-dock-poi'])] }),
...
export const ESTELLA_HIGHLINER_SEEDS = [
...
export const ESTELLA_VALIDATION_ISSUES = validateWorldTree(ESTELLA_NODES);
