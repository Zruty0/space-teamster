...
export const ESTELLA_NODES: WorldNode[] = [
  ...
  orbiting({ id: 'estella-ii', catalogId: 'Estella II', name: 'Estella II', kind: 'planet', regionId: 'hearth', parentId: ROOT_ID, usage: 'stellar', summary: 'Venus-like world with toxic lower atmosphere and a habitable upper cloud layer.', tags: ['venus-like', 'toxic-atmosphere', 'cloud-city'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true }, atmosphere: atmosphere('venuslike-toxic', 'Playable work centers on the habitable upper-atmosphere cloud layer; surface is endgame/deep-pressure.') }),
  orbiting({ id: 'estella-ii-cloud-city-platform', catalogId: undefined, name: 'The Cloud City', kind: 'atmospheric-station', regionId: 'hearth', parentId: 'estella-ii', usage: 'low', summary: 'Iconic atmospheric city in Estella II\'s habitable upper layer.', tags: ['cloud-city', 'luxury', 'atmospheric-platform'], capabilities: { dockable: true, atmosphericPlatform: true }, layoutId: 'cloud-city-exterior', accessPoints: [ap('cloud-city-dock-a', 'Cloud Dock A', 'docking-berth', ['estella-ii-cloud-city'], -80, 0, 0), ap('cloud-city-dock-b', 'Cloud Dock B', 'docking-berth', ['estella-ii-cloud-city'], 80, 0, Math.PI)] }),
  ...
  orbiting({ id: 'estella-iii', catalogId: 'Estella III', name: 'Estella III', kind: 'planet', regionId: 'hearth', parentId: ROOT_ID, usage: 'stellar', summary: 'Earth-like capital world: old money, government, dense traffic, and breathable atmosphere.', tags: ['earth-like', 'capital', 'civilized'], economyTags: ['consumer-goods', 'electronics', 'pharmaceuticals', 'luxury-goods'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true, landable: true }, atmosphere: atmosphere('breathable', 'Earth-like breathable atmosphere.') }),
  ...
  ...stationWithPoi({ stationId: 'estella-iii-luxury-habitat', poiId: 'estella-iii-luxury-orbital-habitat', catalogId: 'Estella III.2', stationName: 'Estella III Luxury Orbital Habitat', parentId: 'estella-iii', regionId: 'hearth', usage: 'high', summary: 'High-orbit luxury habitat.', tags: ['luxury', 'habitat'], economyTags: ['luxury-goods', 'passengers'] }),
  ...
  orbiting({ id: 'estella-iv', catalogId: 'Estella IV', name: 'Estella IV', kind: 'planet', regionId: 'hearth', parentId: ROOT_ID, usage: 'stellar', summary: 'Earth-like sister/rival world with writer-defined biome and culture.', tags: ['earth-like', 'rival-world'], capabilities: { hasGravityWell: true, hasSOI: true, hasSurface: true, hasAtmosphere: true, landable: true }, atmosphere: atmosphere('breathable') }),
